        ...
        <div className="row">
            <div className="col-md-12">
                <div className="jumbotron jumbotron-fluid py-4">
                    ...
                    <br></br>
                        <h1 className="display-4">Jeweller Vendors</h1>
                    </div>
                </div>
            </div>
            ...
            <h1 className="lead text-center">Available Advertisements</h1>
                <table>
                    <tbody>
                        {
                            //tr > 3 td
                            [...Array(Math.ceil(jwellerList.length / 4))].map((e, i) =>
                                <tr key={i}>
                                    <td>{imageCard(jwellerList[4 * i])}</td>
                                    <td>{jwellerList[4 * i + 1] ? imageCard(jwellerList[4 * i + 1]) : null}</td>
                                    <td>{jwellerList[4 * i + 2] ? imageCard(jwellerList[4 * i + 2]) : null}</td>
                                    <td>{jwellerList[4 * i + 3] ? imageCard(jwellerList[4 * i + 3]) : null}</td>
                                </tr>
                            )
                        }
                    </tbody>
